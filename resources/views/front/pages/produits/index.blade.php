                                ...
                                <div class="ltn__main-menu">
                                    <ul>
                                        ...
                                        @if(getAdmin(Auth::user())== true)
                                            ...
                                            <li class="special-link"><a href="{{route('gerant.bilan')}}">GERANT</a> </li>
        ...
        <div class="ltn__utilize-menu-inner ltn__scrollbar">
            ...
            <div class="ltn__utilize-menu">
                <ul>
                    ...
                    <li>                                        
                        @if(getAdmin(Auth::user())== true)
                            <a href="{{route('gerant.bilan')}}">GERANT</a> 
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title-area ltn__section-title-2 text-center">
                        <h1 class="section-title">Nos Matériaux</h1>
                    </div>
                                ...
                                <div class="tab-pane fade active show" id="liton_product_grid">
                                    <div class="ltn__product-tab-content-inner ltn__product-grid-view">
                                        <div class="row">
                                            ...
                                            @foreach($types as $index=>$materiel)
                                                    ...
                                                    <div class="ltn__product-item ltn__product-item-3 text-center">
                                                        <div class="product-img">
                                                            ...
                                                            <div class="product-hover-action">
                                                                <ul>
                                                                    <li>
                                                                        <a href="{{route('materiele.detail',$materiel)}}" title="detail" >
                                                                    ...
                                                                    <li>
                                                                        <a href="{{route('materiele.index')}}" title="{{$materiel['libellé']}}" data-toggle="modal" data-target="#liton_wishlist_modal">
                                                        ...
                                                        <div class="product-info">
                                                            ...
                                                            <h2><div style="color:green; font-size:1em;">{{$materiel['libellé']}}</div></h2>
