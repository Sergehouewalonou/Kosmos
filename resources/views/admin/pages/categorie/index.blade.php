...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h2 class="text-center">LES TYPES DE MATERIELS</h2>
        ...
        <div class="card-block table-border-style">
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tbody>
                    @foreach( $typemateriels as $index=>$typemateriel)
                        <tr>
                            <td>{{$index+1}}</td>
                            <td>{{$typemateriel['libellé']}}</td>
                            <!-- <td>{{$typemateriel['file']}}</td>  -->
                            <td><form action="{{route('typemateriel.optione', $typemateriel )}}" method="POST">
                            @csrf
                            @method('put')
                                ...
                                </div>">{{ $typemateriel->option=='Activé'?'Desactivé' : 'Activé' }}</button>
                            </form></td>
                            <td><a href="{{route('poste.show', $typemateriel)}}"><button type="button" class="btn btn-inverse waves-effect waves-light" data-container="body" data-toggle="popover" title="Inverse color states" data-placement="bottom" data-content="<div class='color-code'>
                                    <div class='row'>
                                    <div class='col-sm-6 col-xs-12'>
                                        <span class='block'>Normal</span>
                                        <span class='block'>
                            ...
                            <td> <a href="{{route('typemateriel.edit', $typemateriel)}}">                                                        <button type="button" class="btn btn-primary waves-effect waves-light" id="primary-popover-content" data-container="body" data-toggle="popover" title="Primary color states" data-placement="bottom" data-content="<div class='color-code'>
                                                            <div class='row'>
                                                              <div class='col-sm-6 col-xs-12'>
                                                                <span class='block'>Normal</span>
                                                                <span class='block'>
