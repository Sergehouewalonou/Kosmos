...
<!-- Mirrored from tunatheme.com/tf/html/broccoli-preview/broccoli/index-6.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 23 Mar 2023 15:03:10 GMT -->
        ...
        <div class="col-lg-5 align-self-center" style="margin-left:150px;">
                            <div class="get-a-quote-wrap">
                                ...
                                <form action="#" method="POST" action="{{ route('welcome') }}" class="get-a-quote-form">
                                ...
                                @csrf
                                    ...
                                    <div class="btn-wrapper" style="display:flex;" >
                                        <div class="col-lg-6">
                                            <button type="submit" class="btn theme-btn-1 btn-effect-1 text-uppercase " style="margin-left:-50px; width:150%;">SE CONNECTER</button>
                                        </div>
                                        <div class="col-lg-6">
                                            <a href="{{ route('register') }}"  class="btn theme-btn-1 btn-effect-1 text-uppercase text-center " style="margin-left:50px;">S'INSCRIRE</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
